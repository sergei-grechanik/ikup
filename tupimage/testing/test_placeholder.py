...
@screenshot_test
def test_placeholder_image_ids(ctx: TestingContext):
    term = ctx.term
    cmd = TransmitCommand(
...
@screenshot_test
def test_placeholder_full_width(ctx: TestingContext):
    term = ctx.term
...
@screenshot_test
def test_placeholder_vertical_stripes(ctx: TestingContext):
    term = ctx.term
    for image_id in [0x123456, 0x12345678]:
        term.write(f"Image id: 0x{image_id:08x}\n")
        cmd = TransmitCommand(
...
@screenshot_test
def test_placeholder_max_columns(ctx: TestingContext):
    term = ctx.term
...
@screenshot_test
def test_placeholder_max_rows(ctx: TestingContext):
    term = ctx.term
